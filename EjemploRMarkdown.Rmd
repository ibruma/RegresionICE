...
author: "M.A. Ibáñez y J. C. Martinez Àvila"
...
`Purines` es un marco de datos que tiene `r nrow(Purines)` filas y `r ncol(Purines)` columnas.
...
```{r,fig.align='center',fig.cap="Gráfico de dispersión de CH4 frente a FND",fig.width=5,fig.height=4}
...
```{r,fig.align='center',fig.cap="Gráfico de dispersión de CH4 frente a FND y recta de regresión estimada",fig.height=4,fig.width=5}
plot(CH4 ~ FND,data=Purines)
