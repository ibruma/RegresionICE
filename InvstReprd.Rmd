...
author: >
    ...
    M. A. Ibáñez (miguel.ibanez@upm.es)  
    
    J.C. Martinez Ávila (jc.martinez.avila@upm.es)  
...
Este documento se puede descargar del repositorio en GitHub  

- [https://github.com/ibruma/RegresionICE.git](https://github.com/ibruma/RegresionICE.git)
...
El formato de salida se obtiene compilando el documento Rmd

- Utilizando el símbolo knit ![](knit.jpg){width=5%} en Rstudio (`Ctrl + Shift + k`)
